...
const FormPage = ({ params }) => {
  ...
  return (
    <main className='flex min-h-screen flex-col items-center text-center md:pt-7'>
      ...
      <span className='text-dark'>Nota: Subir todos los archivos solicitados en formato PDF si tiene una imagen conviértela con <a href="https://www.ilovepdf.com/es/jpg_a_pdf" target="_blank" rel="noopener noreferrer" className='no-underline text-red'>IlovePDF<span className='text-xs'>&#128270;</span></a> Excepto la foto de perfil</span>
